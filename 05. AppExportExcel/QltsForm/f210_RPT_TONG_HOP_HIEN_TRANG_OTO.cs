...
namespace QltsForm
{
	...
	public class f210_RPT_TONG_HOP_HIEN_TRANG_OTO : System.Windows.Forms.Form
	{
		...
		public f210_RPT_TONG_HOP_HIEN_TRANG_OTO()
		{
			//
          ...
          , ref IP.Core.QltsFormControls.CObjExcelAssetParameters op_obj_excel_parameters)
        {
            ...
            switch (ip_str_loai_bao_cao)
            {
                case TINH_HINH_SU_DUNG.TONG_HOP_CHUNG:
                    v_obj_exe_report = new CExcelWebReport("BC-410 BCTH-THSDOTO-THC.xls", 17, 1); ;
                    load_data_to_grid_thsd_tong_hop_chung(op_obj_excel_parameters);
                    break;
                case TINH_HINH_SU_DUNG.DON_VI_SU_DUNG:
                    v_obj_exe_report = new CExcelWebReport("BC-410 BCTH-THSDOTO-CT.xls", 17, 1); ;
...
,KHONG_KINH_DOANH = 8
        ...
        private void load_data_to_grid_thsd_tong_hop_chung(CObjExcelAssetParameters op_excel_parameters)
        {
            ...
            v_us_rpt_tong_hop_hien_trang_oto.FillDataset_tong_hop_chung(
		...
		//	f210_RPT_TONG_HOP_HIEN_TRANG_OTO_DE v_fDE = new  f210_RPT_TONG_HOP_HIEN_TRANG_OTO_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}
...
//
		...
		//
		//
		private void f210_RPT_TONG_HOP_HIEN_TRANG_OTO_Load(object sender, System.EventArgs e) {
			try{
