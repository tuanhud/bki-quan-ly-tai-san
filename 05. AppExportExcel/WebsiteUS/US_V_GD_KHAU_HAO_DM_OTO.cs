///************************************************
/// Generated by: Vanna
/// Date: 23/08/2013 04:48:08
/// Goal: Create User Service Class for V_GD_KHAU_HAO_DM_OTO
///************************************************
/// <summary>
/// Create User Service Class for V_GD_KHAU_HAO_DM_OTO
/// </summary>
...
namespace WebUS
{
    ...
    public class US_V_GD_KHAU_HAO_DM_OTO : US_Object
    {
        private const string c_TableName = "V_GD_KHAU_HAO_DM_OTO";
        ...
        public US_V_GD_KHAU_HAO_DM_OTO()
        {
            pm_objDS = new DS_V_GD_KHAU_HAO_DM_OTO();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_V_GD_KHAU_HAO_DM_OTO(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_V_GD_KHAU_HAO_DM_OTO(decimal i_dbID)
        {
            pm_objDS = new DS_V_GD_KHAU_HAO_DM_OTO();
            pm_strTableName = c_TableName;
        ...
        public void FillDatasetLoadDataToGridOto_by_tu_khoa(
            ...
            , DS_V_GD_KHAU_HAO_DM_OTO op_ds_v_gd_kh_dm_oto)
        {
            CStoredProc v_obj_procedure = new CStoredProc("pr_V_GD_KHAU_HAO_DM_OTO_Load_data_to_grid_by_tu_khoa");
            ...
            v_obj_procedure.fillDataSetByCommand(this, op_ds_v_gd_kh_dm_oto);
        }
        #endregion
    }
}
