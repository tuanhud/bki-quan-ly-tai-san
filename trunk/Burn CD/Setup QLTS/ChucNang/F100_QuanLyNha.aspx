<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" enableeventvalidation="false" inherits="ChucNang_F100_QuanLyNha, App_Web_pnkqqndn" %>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <asp:Button ID="m_cmd_tao_tang_giam" AccessKey="c" CssClass="cssButton" runat="server"
                                                ...
                                                &nbsp;
                                            <asp:Button ID="m_cmd_huy_bo" AccessKey="c" CssClass="cssButton" runat="server" Height="24px" CausesValidation="false"
                                                Width="98px" Text="Hủy bỏ" OnClick="m_cmd_huy_bo_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <td colspan="4">
                        <table cellspacing="0" cellpadding="2" style="width: 100%;" class="cssTable" border="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 30%" align="left">
                                    <asp:DropDownList ID="m_ddl_thuoc_khu_dat" runat="server" Width="85%" ValidationGroup="m_vlg_nha"
                                        AutoPostBack="true" OnSelectedIndexChanged="m_ddl_thuoc_khu_dat_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td align="left" style="width: 1%;">
                                </td>
                                ...
                                <td align="left" style="width: 30%;">
                                    <asp:DropDownList ID="m_ddl_don_vi_dau_tu" runat="server" Width="85%" ValidationGroup="m_vlg_nha"
                                        AutoPostBack="true" OnSelectedIndexChanged="m_ddl_don_vi_dau_tu_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td align="left" style="width: 1%;">
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 30%;">
                                    <asp:TextBox ID="m_txt_nam_xd" runat="server" CssClass="cssTextBox cssNumber" Width="85%"
                                        ValidationGroup="m_vlg_nha"></asp:TextBox>
                                </td>
                                <td align="left" style="width: 1%;">
                                </td>
                ...
                <tr>
                    ...
                    <td align="left" style="width: 30%">
                        <asp:TextBox ID="m_txt_tu_khoa" runat="server" CssClass="cssTextBox" Width="85%"
                            AutoPostBack="true" CausesValidation="false" OnTextChanged="m_txt_tu_khoa_TextChanged"></asp:TextBox>
                    </td>
                    <td align="left">
                    </td>
                    <td align="left">
