<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="ChucNang_F110_DieuChuyenNoiBoNha, App_Web_fdvpccf2" enableeventvalidation="false" %>
            ...
            <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
                <tr>
                    <td class="cssPageTitleBG" colspan="4">
                        <asp:Label ID="m_lbl_caption" runat="server" Text="ĐIỀU CHUYỂN NỘI BỘ TÀI SẢN NHÀ"
                ...
                <tr>
                    ...
                    <td align="left" style="width: 30%">
                        <asp:DropDownList ID="m_cbo_don_vi_su_dung_moi" runat="server" AutoPostBack="true"
                            OnSelectedIndexChanged="m_cbo_don_vi_su_dung_moi_SelectedIndexChanged" Width="85%">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
