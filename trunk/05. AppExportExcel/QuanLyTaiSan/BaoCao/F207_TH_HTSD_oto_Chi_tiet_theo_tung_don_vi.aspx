<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="F207_TH_HTSD_oto_Chi_tiet_theo_tung_don_vi.aspx.cs" Inherits="BaoCao_F207_TH_HTSD_oto_Chi_tiet_theo_tung_don_vi" %>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="cssTable">
                    <tr>
                        <td class="cssPageTitleBG" colspan="6">
                            ...
                            <br />
                            <span class="cssPageTitle">Phần 2: Chi tiết theo từng đơn vị</span><span class="expand-collapse-text initial-expand"></span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6">
