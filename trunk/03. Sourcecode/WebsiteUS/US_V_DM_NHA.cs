...
namespace WebUS
{
    public class US_V_DM_NHA : US_Object
    {
        ...
        public string strTRANG_THAI_NHA
        {
            get
            {
                return CNull.RowNVLString(pm_objDR, "TRANG_THAI_NHA", IPConstants.c_DefaultString);
            }
            set
            {
                pm_objDR["TRANG_THAI_NHA"] = value;
            }
        }

        public bool IsTRANG_THAI_NHANull()
        {
            return pm_objDR.IsNull("TRANG_THAI_NHA");
        }

        public void SetTRANG_THAI_NHANull()
        {
            pm_objDR["TRANG_THAI_NHA"] = System.Convert.DBNull;
        }
        ...
        public US_V_DM_NHA(DataRow i_objDR)
            : this()
        {
        ...
        #region Addition
        public void FillDatasetLoadDataToGridNha(
