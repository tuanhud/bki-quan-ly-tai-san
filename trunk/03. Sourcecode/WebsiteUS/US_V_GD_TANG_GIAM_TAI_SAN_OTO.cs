///************************************************
/// Generated by: TuDM
/// Date: 15/09/2013 10:40:33
/// Goal: Create User Service Class for V_GD_TANG_GIAM_TAI_SAN_OTO
///************************************************
/// <summary>
/// Create User Service Class for V_GD_TANG_GIAM_TAI_SAN_OTO
/// </summary>
...
namespace AuctionUS
{
    ...
    public class US_V_GD_TANG_GIAM_TAI_SAN_OTO : US_Object
    {
        private const string c_TableName = "V_GD_TANG_GIAM_TAI_SAN_OTO";
        ...
        public US_V_GD_TANG_GIAM_TAI_SAN_OTO()
        {
            pm_objDS = new DS_V_GD_TANG_GIAM_TAI_SAN_OTO();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_V_GD_TANG_GIAM_TAI_SAN_OTO(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_V_GD_TANG_GIAM_TAI_SAN_OTO(decimal i_dbID)
        {
            pm_objDS = new DS_V_GD_TANG_GIAM_TAI_SAN_OTO();
            pm_strTableName = c_TableName;
        ...
        public void FillDatasetLoadDataToGridOto_by_tu_khoa(
            ...
            , DS_V_GD_TANG_GIAM_TAI_SAN_OTO op_ds_v_gd_tang_giam_tai_san_oto)
        {
            CStoredProc v_obj_procedure = new CStoredProc("pr_V_GD_TANG_GIAM_TAI_SAN_OTO");
            ...
            v_obj_procedure.fillDataSetByCommand(this, op_ds_v_gd_tang_giam_tai_san_oto);
        }
        #endregion
    }
}
