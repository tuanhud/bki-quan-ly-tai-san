///************************************************
/// Generated by: linhdh
/// Date: 06/03/2012 05:41:27
/// Goal: Create User Service Class for RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP
///************************************************
/// <summary>
/// Create User Service Class for RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP
/// </summary>
...
public class US_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP : US_Object
{
	private const string c_TableName = "RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP";
...
#region "Init Functions"
	public US_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP() 
	{
		pm_objDS = new DS_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP(decimal i_dbID) 
	{
		pm_objDS = new DS_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP();
		pm_strTableName = c_TableName;
    ...
    public void bao_cao_thong_ke_so_hd_da_thanh_toan_giang_vien(DS_RPT_BAO_CAO_THONG_KE_HD_THANH_TOAN_GV_TONG_HOP op_ds_rpt_thong_ke_thanh_toan_gv_tong_hop, decimal ip_dc_thang, decimal ip_dc_nam)
    {
        CStoredProc v_cstore = new CStoredProc("pr_V_DM_HOP_DONG_KHUNG_Bao_Cao_Tong_hop_so_HD_theo_Thanh_Toan");
        v_cstore.addDecimalInputParam("@thang", ip_dc_thang);
        v_cstore.addDecimalInputParam("@nam", ip_dc_nam);
        v_cstore.fillDataSetByCommand(this, op_ds_rpt_thong_ke_thanh_toan_gv_tong_hop);
    }
    #endregion
}
}
