///************************************************
/// Generated by: Vanna
/// Date: 18/08/2013 10:35:43
/// Goal: Create User Service Class for V_GD_KHAU_HAO_DM_NHA
///************************************************
/// <summary>
/// Create User Service Class for V_GD_KHAU_HAO_DM_NHA
/// </summary>
...
namespace WebUS
{
    ...
    public class US_V_GD_KHAU_HAO_DM_NHA : US_Object
    {
        private const string c_TableName = "V_GD_KHAU_HAO_DM_NHA";
        ...
        public US_V_GD_KHAU_HAO_DM_NHA()
        {
            pm_objDS = new DS_V_GD_KHAU_HAO_DM_NHA();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_V_GD_KHAU_HAO_DM_NHA(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_V_GD_KHAU_HAO_DM_NHA(decimal i_dbID)
        {
            pm_objDS = new DS_V_GD_KHAU_HAO_DM_NHA();
            pm_strTableName = c_TableName;
        ...
        #region Additional
        public void FillDatasetByKeyWord(DS_V_GD_KHAU_HAO_DM_NHA op_ds_v_gd_kh_dm_nha
            , string ip_str_key_word
            , decimal ip_dc_id)
        {
            CStoredProc v_cstore = new CStoredProc("pr_V_GD_KHAU_HAO_DM_NHA_Search_By_Dat");
            v_cstore.addNVarcharInputParam("@TU_KHOA", ip_str_key_word);
            v_cstore.addDecimalInputParam("@ID", ip_dc_id);
            v_cstore.fillDataSetByCommand(this, op_ds_v_gd_kh_dm_nha);
        }
        #endregion
    }
}
