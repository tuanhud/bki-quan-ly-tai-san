///************************************************
/// Generated by: TUDM
/// Date: 24/08/2013 07:01:17
/// Goal: Create User Service Class for V_DM_DAT_HISTORY
///************************************************
/// <summary>
/// Create User Service Class for V_DM_DAT_HISTORY
/// </summary>
...
namespace WebUS
{
	...
	public class US_V_DM_DAT_HISTORY : US_Object
	{
		private const string c_TableName = "V_DM_DAT_HISTORY";
        ...
        public US_V_DM_DAT_HISTORY()
        {
            pm_objDS = new DS_V_DM_DAT_HISTORY();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_V_DM_DAT_HISTORY(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_V_DM_DAT_HISTORY(decimal i_dbID)
        {
            pm_objDS = new DS_V_DM_DAT_HISTORY();
            pm_strTableName = c_TableName;
            ...
            , DS_V_DM_DAT_HISTORY op_ds_dat_history)
        {
            ...
            CStoredProc v_obj_procedure = new CStoredProc("pr_V_DM_DAT_HISTORY_Search");
            ...
            v_obj_procedure.addDecimalInputParam("@ip_id_dat", ip_id_dat);
        ...
        public void FillDatasetLoaiHinh(
            decimal ip_dc_bo_tinh
            , decimal ip_dc_don_vi_chu_quan
            , decimal ip_dc_don_vi_su_dung
            , decimal ip_id_dat
            ...
            , DS_V_DM_DAT_HISTORY op_ds_dat_history)
        {
            ...
            CStoredProc v_obj_procedure = new CStoredProc("pr_V_DM_DAT_HISTORY_search_by_id_don_vi_loai_hinh_tu_khoa");
            v_obj_procedure.addDecimalInputParam("@ip_id_bo_tinh", ip_dc_bo_tinh);
            v_obj_procedure.addDecimalInputParam("@ip_id_dv_chu_quan", ip_dc_don_vi_chu_quan);
            v_obj_procedure.addDecimalInputParam("@ip_id_dv_su_dung", ip_dc_don_vi_su_dung);
            v_obj_procedure.addDecimalInputParam("@ip_dc_id_trang_thai_dat", ip_id_dat);
            v_obj_procedure.addNVarcharInputParam("@ip_str_user_name", ip_str_user_name);
