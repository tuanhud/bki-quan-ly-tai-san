...
public partial class ChucNang_F100_QuanLyNha : System.Web.UI.Page
{
    ...
    private void load_data_don_vi_chu_quan(string ip_id_bo_tinh)
    {
        US_DM_DON_VI v_us_dm_don_vi = new US_DM_DON_VI();
        DS_DM_DON_VI v_ds_dm_don_vi = new DS_DM_DON_VI();

        v_us_dm_don_vi.FillDataset(v_ds_dm_don_vi, "where ID_LOAI_DON_VI = " + ID_LOAI_DON_VI.DV_CHU_QUAN 
            + " AND ID_DON_VI_CAP_TREN LIKE '%" + ip_id_bo_tinh + "%'");
    ...
    private void load_data_don_vi_su_dung(string ip_id_don_vi_chu_quan)
    {
        US_DM_DON_VI v_us_dm_don_vi = new US_DM_DON_VI();
        DS_DM_DON_VI v_ds_dm_don_vi = new DS_DM_DON_VI();

        v_us_dm_don_vi.FillDataset(v_ds_dm_don_vi, "where ID_LOAI_DON_VI IN (" + ID_LOAI_DON_VI.DV_SU_DUNG + "," + ID_LOAI_DON_VI.DV_CHU_QUAN
            + " ) AND (ID_DON_VI_CAP_TREN LIKE '%" + ip_id_don_vi_chu_quan + "%' OR ID LIKE '%" + ip_id_don_vi_chu_quan + "%')");
    ...
    private void load_data_dat(string ip_id_don_vi_su_dung)
    {
        DS_DM_DAT v_ds_dm_dat = new DS_DM_DAT();
        US_DM_DAT vs_us_dm_dat = new US_DM_DAT();

        vs_us_dm_dat.FillDataset(v_ds_dm_dat, "where ID_DON_VI_SU_DUNG LIKE '%" + ip_id_don_vi_su_dung + "%'");
    ...
    private void load_data_to_us_by_id(decimal ip_us_dm_nha_id)
    {
        m_us_dm_nha = new US_DM_NHA(ip_us_dm_nha_id);
        load_data_from_us();
    }
    ...
    {
        load_data_don_vi_su_dung(m_ddl_don_vi_chu_quan.SelectedValue);
    }
