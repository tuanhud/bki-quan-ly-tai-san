...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="m_grv_danh_sach_oto" runat="server" AllowPaging="True"
                    ...
                    ShowHeader="true" onpageindexchanging="m_grv_danh_sach_oto_PageIndexChanging" 
                    onrowcommand="m_grv_danh_sach_oto_RowCommand">
                    <Columns>
