...
public partial class BaoCao_F205_TH_HTSD_tai_san_khac_Chi_tiet_theo_tung_don_vi : System.Web.UI.Page
{
    #region Members
    ...
    private void load_data_to_grid(string ip_str_id_bo_tinh, string ip_str_id_don_vi_chu_quan)
    {
        ...
        m_grv_tai_san_khac.DataSource = v_DS_RPT_TONG_HOP_HIEN_TRANG_TSK.RPT_TONG_HOP_HIEN_TRANG_TSK;
        Thread.Sleep(1000);
