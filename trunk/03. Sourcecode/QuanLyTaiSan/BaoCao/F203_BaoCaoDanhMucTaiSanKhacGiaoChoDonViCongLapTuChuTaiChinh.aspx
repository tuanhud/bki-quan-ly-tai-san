<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="F203_BaoCaoDanhMucTaiSanKhacGiaoChoDonViCongLapTuChuTaiChinh.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table cellspacing="0" cellpadding="2" style="width: 100%;" class="cssTable" border="0">
        ...
        <tr>
            <td align="right" style="width: 15%;">
                <span class="cssManField">Đơn vị được giao tài sản</span>
            </td>
            <td style="width: 20%;">
                <asp:DropDownList ID="m_cbo_don_vi_duoc_giao_tai_san" runat="server" Width="96%" CssClass="cssDorpdownlist">
                </asp:DropDownList>
            </td>
            <td></td>
        </tr>
    ...
    <table cellspacing="0" cellpadding="2" style="width: 100%;" class="cssTable" border="0">
        <tr>
            ...
            <span class="cssPageTitle">DANH MỤC TÀI SẢN KHÁC GIAO CHO ĐƠN VỊ SỰ NGHIỆP CÔNG LẬP TỰ CHỦ TÀI CHÍNH</span>
            <span class="expand-collapse-text initial-expand">
                </span><span class="expand-collapse-text"></span>
            </td>
        </tr>
