...
public partial class BaoCao_F309_TH_HTSD_nha_dat_Chi_tiet_theo_tung_don_vi : System.Web.UI.Page
{
    #region Members
    ...
    private void export_excel()
    {
        ...
        WinformReport.export_gridview_2_excel(
                       m_grv_tai_san_nha_dat
                        , "Báo cáo THSD nhà đất - chi tiết theo đơn vị.xls"
                        );
    }
    #endregion
    ...
    protected void m_grv_tai_san_nha_dat_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            m_grv_tai_san_nha_dat.PageIndex = e.NewPageIndex;
            load_data_to_grid(
                m_cbo_bo_tinh.SelectedValue
                , m_cbo_don_vi_chu_quan.SelectedValue);
        }
