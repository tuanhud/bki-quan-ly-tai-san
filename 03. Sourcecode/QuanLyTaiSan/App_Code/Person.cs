...
public class Person
{
    ...
    public static string get_chuc_nang()
    {
        ...
        return CIPConvert.ToStr(HttpContext.Current.Request.Url.PathAndQuery).Replace("/QuanLyTaiSan/", "");
    }
    public static string get_chuc_nang_without_query()
    {
        return CIPConvert.ToStr(HttpContext.Current.Request.Url.AbsolutePath).Replace("/QuanLyTaiSan/", "");
    }
