///************************************************
/// Generated by: MinhNN
/// Date: 25/07/2013 10:04:01
/// Goal: Create User Service Class for DM_OTO
///************************************************
/// <summary>
/// Create User Service Class for DM_OTO
/// </summary>
...
namespace WebUS
{
    ...
    public class US_DM_OTO : US_Object
    {
        private const string c_TableName = "DM_OTO";
        ...
        public decimal dcTAI_TRONG
        {
            get
            {
                return CNull.RowNVLDecimal(pm_objDR, "TAI_TRONG", IPConstants.c_DefaultDecimal);
            }
            set
            {
                pm_objDR["TAI_TRONG"] = value;
            }
        }

        public bool IsTAI_TRONGNull()
        {
            return pm_objDR.IsNull("TAI_TRONG");
        }

        public void SetTAI_TRONGNull()
        {
            pm_objDR["TAI_TRONG"] = System.Convert.DBNull;
        }

        public DateTime datNAM_SAN_XUAT
        {
            get
            {
                return CNull.RowNVLDate(pm_objDR, "NAM_SAN_XUAT", IPConstants.c_DefaultDate);
            }
            set
            {
        ...
        public DateTime datNAM_SU_DUNG
        {
            get
            {
                return CNull.RowNVLDate(pm_objDR, "NAM_SU_DUNG", IPConstants.c_DefaultDate);
            }
            set
            {
        ...
        public string strCHUC_DANH_SU_DUNG_XE
        {
            get
            {
                return CNull.RowNVLString(pm_objDR, "CHUC_DANH_SU_DUNG_XE", IPConstants.c_DefaultString);
            }
            set
            {
                pm_objDR["CHUC_DANH_SU_DUNG_XE"] = value;
            }
        }

        public bool IsCHUC_DANH_SU_DUNG_XENull()
        {
            return pm_objDR.IsNull("CHUC_DANH_SU_DUNG_XE");
        }

        public void SetCHUC_DANH_SU_DUNG_XENull()
        {
            pm_objDR["CHUC_DANH_SU_DUNG_XE"] = System.Convert.DBNull;
        }
        ...
        public US_DM_OTO()
        {
            pm_objDS = new DS_DM_OTO();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_DM_OTO(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_DM_OTO(decimal i_dbID)
        {
            pm_objDS = new DS_DM_OTO();
            pm_strTableName = c_TableName;
