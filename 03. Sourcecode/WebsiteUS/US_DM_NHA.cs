...
namespace WebUS
{
    ...
    public class US_DM_NHA : US_Object
    {
        ...
        public void load_nha(DS_DM_NHA op_ds_dm_nha)
        {
            CStoredProc v_sp_select_all = new CStoredProc("pr_DM_NHA_SelectAll");
            v_sp_select_all.fillDataSetByCommand(this, op_ds_dm_nha);
        }
        #endregion
    }
}
