<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" enableeventvalidation="false" inherits="ChucNang_F105_KhauHaoDat, App_Web_pnkqqndn" %>
                ...
                <tr>
                    <td class="cssPageTitleBG" colspan="6">
                        <asp:Label ID="m_lbl_thong_tin_khau_hao_dat" runat="Server" class="cssPageTitle"
                            Text="DANH SÁCH CÁC LẦN HAO MÒN TÀI SẢN ĐẤT"></asp:Label>
