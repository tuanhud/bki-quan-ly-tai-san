<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" enableeventvalidation="false" inherits="ChucNang_F106_DuyetGhiTangNha, App_Web_fdvpccf2" %>
        ...
        <ContentTemplate>
            <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
                ...
                <tr>
                    ...
                    <td style="width: 30%" align="left">
                        <asp:DropDownList ID="m_cbo_trang_thai_nha_up" runat="server" Width="85%" ValidationGroup="m_vlg_nha"
                            Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="m_cbo_trang_thai_nha_up_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="right" style="width: 15%">
                        <asp:Label ID="m_lbl_ten_don_vi_nhan_dieu_chuyen" runat="server" Text="Đơn vị nhận điều chuyển *"
                            CssClass="cssManField"></asp:Label>
                    </td>
                    <td align="left" style="width: 30%">
            ...
            <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
                <tr>
                    <td class="cssPageTitleBG" colspan="4">
                        <asp:Label ID="m_lbl_thong_tin_nha" runat="server" Text="DANH SÁCH DUYỆT GHI TĂNG GIẢM TÀI SẢN"
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:Button ID="m_cmd_tim_kiem" runat="server" AccessKey="s" CssClass="cssButton"
                            CausesValidation="false" Height="24px" Text="Tìm kiếm" Width="98px" OnClick="m_cmd_tim_kiem_Click" />
                    </td>
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="m_grv_danh_sach_nha" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            EmptyDataText="Không có dữ liệu phù hợp" PageSize="30" ShowHeader="true" CssClass="cssGrid"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Sửa" ItemStyle-Width="2%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="m_lbt_edit" runat="server" CommandName="EditComp" ToolTip="Sửa" CausesValidation="false"
