<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" enableeventvalidation="false" inherits="ChucNang_F500_QuanLyOto, App_Web_fdvpccf2" %>
            ...
            <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
                ...
                <tr>
                    <td class="cssPageTitleBG" colspan="4">
                        <asp:Label ID="m_lbl_caption" runat="server" CssClass="cssPageTitle" Text="" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
