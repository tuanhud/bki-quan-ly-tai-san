<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" enableeventvalidation="false" inherits="ChucNang_F303_khau_hao_tai_san_khac, App_Web_fdvpccf2" %>
            ...
            <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
                <tr>
                    <td class="cssPageTitleBG" colspan="4">
                        <span class="cssPageTitle">HAO MÒN TÀI SẢN KHÁC</span> <span class="expand-collapse-text initial-expand">
                                ...
                                <asp:TemplateField HeaderText="Xóa" ItemStyle-Width="2%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="m_lbt_delete" runat="server" CommandName="DeleteComp" ToolTip="Xóa"
                                            CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' OnClientClick="return confirm ('Bạn có thực sự muốn xóa bản ghi này?')">
